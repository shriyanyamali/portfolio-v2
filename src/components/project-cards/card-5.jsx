  ...
  return (
    <CardContainer className="inter-var">
      <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-[30rem] txl:w-[22rem] mg:w-[19rem] md:!w-[27rem] xs:!w-auto h-auto rounded-xl p-6 border  ">
        ...
        >
          A index where you can search keywords related to return market
          definitions decided in European Commission competition cases.
        </CardItem>
        <CardItem translateZ="100" className="w-full mt-4">
          <Image
            src="/images/projects/verdictr.png"
            height="500"
            width="500"
        ...
        <div className="flex justify-between items-center mt-20">
          ...
          <Link href="https://law.stanford.edu/" target="_blank">
            <CardItem
              translateZ={20}
              as="button"

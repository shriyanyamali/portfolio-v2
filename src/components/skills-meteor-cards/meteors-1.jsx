...
export function MeteorsDemo1() {
  return (
    (<div className="">
      <div className=" w-full relative max-w-lg xtl:max-w-[23rem] lg:max-w-xs">
        <div
        ...
        <div
          className="min-h-64 relative shadow-xl bg-slate-200 dark:bg-gray-900 border border-gray-300 dark:border-gray-800  px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-col justify-end items-start">
          <div
          ...
          <p className="font-normal text-base text-slate-700 dark:text-slate-500 mb-4 relative z-50">
            ...
            Won the Best Attorney Award out of more than 300 other 9th, 10th, 11th, and 12th grade attorneys throughout the state of Delaware.
          </p>

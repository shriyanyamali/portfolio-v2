...
export const GlareCard = ({ children, className }) => {
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[390px] [aspect-ratio:17/21] xtl:w-[270px] lg:w-[220px]xtl:ml-4"
      ref={refElement}
      onPointerMove={(event) => {
        ...
        <div className="w-full h-full grid [grid-area:1/1] mix-blend-soft-light [clip-path:inset(0_0_0_0_round_var(--radius))]">
          <div
            className={cn(
              ...
              className,
              "bg-[url('https://images.unsplash.com/photo-1694634690964-787bac284ffb?q=80&w=2127&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]",
              "dark:bg-[url('https://images.unsplash.com/photo-1536746803623-cef87080bfc8?q=80&w=1970&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]",
            )}
          >
            {children}
          </div>

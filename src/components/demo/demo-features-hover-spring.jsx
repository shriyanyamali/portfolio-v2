...
const ProjectsData = [
  ...
  },
  {
    ...
    description:
      "Worked with Stanford University and Vrije Universiteit Amsterdam to use machine learning processes to analyze thousands of antitrust cases.",
    image:
  ...
  },
  {
    ...
    description:
      "Held leadership positions at the state and local level. Won first place twice nationally in leadership related events at the Business Professionals of America 2024 NLC.",
    image:
